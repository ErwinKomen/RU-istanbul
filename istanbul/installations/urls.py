...
urlpatterns = [
	...
	path('add_institutiontype/<str:view>',views.edit_institutiontype, 
        name = 'add_institutiontype'),
	path('add_installationtype/',views.edit_installationtype, 
        name = 'add_installationtype'),
	path('add_installationtype/<str:view>',views.edit_installationtype, 
        name = 'add_installationtype'),
	...
	path('edit_institutiontype/<int:pk>/<str:focus>',views.edit_institutiontype, 
        name = 'edit_institutiontype'),
	path('edit_installationtype/<int:pk>',views.edit_installationtype, 
        name = 'edit_installationtype'),
	path('edit_installationtype/<int:pk>/<str:focus>',views.edit_installationtype, 
        name = 'edit_installationtype'),
	...
	path('edit_texttype/<int:pk>/<str:focus>', views.edit_texttype, 
        name = 'edit_texttype'),
